...
import (
	...
	"github.com/starlingvibes/Simple-CRUD-MonGo/responses"
...
func DeleteAUser() http.HandlerFunc{
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		if result.DeletedCount < 1 {
			...
			response := responses.UserResponse{Status: http.StatusNotFound, Message: "error", Data: map[string]interface{}{"data": "user not found"}}
			json.NewEncoder(rw).Encode(response)
			return
		}
